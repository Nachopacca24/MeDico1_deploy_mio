...
import { ChevronRight, X, BookOpen, ChevronUp, ChevronDown } from 'lucide-react';
...
export function TutorialCard() {
  ...
  // Al cambiar de paso, expandir para que el usuario vea el contenido nuevo
  useEffect(() => {
    setCollapsed(false);
  }, [tutorialState.step]);
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        <div className={`flex items-center justify-between gap-2 ${!collapsed ? '' : 'mt-3'}`}>
          <button
            onClick={skipTutorial}
