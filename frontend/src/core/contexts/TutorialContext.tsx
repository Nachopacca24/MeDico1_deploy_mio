...
// - No hay tabla de códigos de anestesia para explorar antes (a diferencia de
//   /operations para cirujanos) — los códigos se buscan y se marcan ⭐ dentro
//   del propio formulario del caso (AnesthesiaCodesPicker), así que ese paso
//   no existe acá; se enseña en el momento, en "③ Códigos de anestesia".
// - La calculadora rápida (/calculator) es 100% quirúrgica — no tiene códigos
//   de anestesia — así que no aparece en este recorrido.
// - Los casos de anestesia no tienen subida de fotos (sí los de cirugía).
...
export const ANESTHESIA_TUTORIAL_STEPS: TutorialStep[] = [
  {
    step: 1, route: '/hospitals', emoji: '🏥', target: 'hospitals-list',
    title: 'Configurá tu hospital',
  ...
  {
    step: 2, route: '/insurances', emoji: '🛡️', target: 'insurances-list',
    title: 'Seguros médicos',
  ...
  {
    step: 3, route: '/favorites', emoji: '⭐', target: 'favorites-list',
    title: 'Tus favoritos',
  ...
  {
    step: 4, route: '/colleagues', emoji: '👥', target: 'colleague-code',
    title: 'Colegas',
  ...
  {
    step: 5, route: '/calendar', emoji: '📅', target: 'calendar-connect',
    title: 'Google Calendar',
  ...
  {
    step: 6, route: '/cases', emoji: '📨', target: 'anesthesia-invitations',
  ...
  {
    step: 7, route: '/cases', emoji: '📋', target: 'new-anesthesia-btn',
  ...
  {
    step: 8, route: '/cases/new/anesthesia', emoji: '👤', target: 'patient-data',
    title: '① Datos del paciente',
    description: 'Completá el nombre, ID de expediente, edad, género y diagnóstico del paciente. Para practicar usá: Nombre → Juan Pérez · ID → 123 · Edad → 45.',
    hint: 'Los datos del paciente están cifrados — solo vos podés verlos.',
  },
  {
    step: 9, route: '/cases/new/anesthesia', emoji: '🏥', target: 'hospital-selector',
  ...
  {
    step: 10, route: '/cases/new/anesthesia', emoji: '🩺', target: 'anesthesia-codes-picker',
    title: '③ Códigos de anestesia',
    description: 'A diferencia de los procedimientos quirúrgicos, tus códigos de anestesia no tienen una tabla aparte para explorar antes — los buscás acá mismo, dentro del caso. Tocá la ⭐ junto a un resultado para guardarlo como favorito — la próxima vez aparece arriba en "Procedimientos Frecuentes" para agregarlo con un solo toque.',
  ...
  {
    step: 11, route: '/cases/new/anesthesia', emoji: '💾', target: 'save-case-btn',
  ...
  {
    step: 15, route: '/settings', emoji: '⚙️', target: 'settings-plan-tab',
    title: '¡Listo! Configuración final',
    description: 'Último paso: revisá Configuración. En "Perfil" guardás tu especialidad. En "Preferencias" elegís modo oscuro o claro y configurás el recordatorio de notificaciones para tus cirugías. Si te queda alguna duda — sobre suscripción, referidos o privacidad — encontrás las Preguntas frecuentes en esta misma pestaña "Tutorial".',
    hint: 'El recordatorio de cirugía te avisa con anticipación — podés elegir cuántas horas antes querés recibirlo.',
  },
